...
data_path = os.path.join("hw3_autograder", "data")
ref_data_path = os.path.join( "hw3_autograder", "data", "ctc_ref_data")
...
class CTCTest(Test):
    ...
    def test_ctc_extend_seq(self):
        # Get curr data
        probs = np.load(os.path.join( r'C:\Users\sc\Desktop\hw3p1-handout',"autograder",data_path, "X.npy"))
        targets = np.load(os.path.join( r'C:\Users\sc\Desktop\hw3p1-handout',"autograder",data_path, "Y.npy"))
        input_lens = np.load(os.path.join( r'C:\Users\sc\Desktop\hw3p1-handout',"autograder",data_path, "X_lens.npy"))
        out_lens = np.load(os.path.join( r'C:\Users\sc\Desktop\hw3p1-handout',"autograder",data_path, "Y_lens.npy"))

        CTC_user = CTC(BLANK=0)

        f_ref_S_ext = open(os.path.join( r'C:\Users\sc\Desktop\hw3p1-handout',"autograder",ref_data_path, "ref_S_ext.pkl"), "rb")
        f_ref_Skip_Connect = open(
            os.path.join( r'C:\Users\sc\Desktop\hw3p1-handout',"autograder",ref_data_path, "ref_Skip_Connect.pkl"), "rb"
        )
    ...
    def test_ctc_posterior_prob(self):
        ...
        f_ref_alpha = open(os.path.join( r'C:\Users\sc\Desktop\hw3p1-handout',"autograder",ref_data_path, "ref_alpha.pkl"), "rb")
        f_ref_beta = open(os.path.join( r'C:\Users\sc\Desktop\hw3p1-handout',"autograder",ref_data_path, "ref_beta.pkl"), "rb")
        f_ref_gamma = open(os.path.join( r'C:\Users\sc\Desktop\hw3p1-handout',"autograder",ref_data_path, "ref_gamma.pkl"), "rb")
    ...
    def test_ctc_forward(self):
        ...
        ref_loss = np.load(os.path.join(r'C:\Users\sc\Desktop\hw3p1-handout\autograder',ref_data_path, "ref_loss.npy"))
    ...
    def test_ctc_backward(self):
        ...
        ref_dy = np.load(os.path.join( r'C:\Users\sc\Desktop\hw3p1-handout',"autograder",ref_data_path, "ref_dy.npy"))
